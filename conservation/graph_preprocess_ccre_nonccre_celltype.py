...
for chromosome in chromosomes :
    ...
    ccre = ccre.loc[(ccre[9]=='pELS') | (ccre[9]=='pELS,CTCF-bound') | (ccre[9]=='dELS') | (ccre[9]=='dELS,CTCF-bound')]
...
np.save('graphs/dataset_101_chr{}_ccre_nonccre_{}_X_val.npy'.format('All', celltype), X_train101)
np.save('graphs/dataset_101_chr{}_ccre_nonccre_{}_y_val.npy'.format('All', celltype), y_train101)
