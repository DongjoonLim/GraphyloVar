...
PHACT~\citep{kim2021phact} and its gradient-boosted extension PHACTboost use
...
GraphyloVar \rev{operates in a fundamentally different scope: it predicts the
...
{\rev{The two approaches are therefore complementary rather than competing.}}
