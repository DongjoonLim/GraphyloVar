...
The model processes linear alignment data into **graph-structured inputs**, feeding them into a neural network architecture that combines **Transformer** (for sequential dependencies), **GCNs** (for phylogenetic topology).
